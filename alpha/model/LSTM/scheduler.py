...
from alpha.model.LSTM.dataset import *
from alpha.model.LSTM.model import *
...
class lstm_scheduler:
    ...
    def train(self, srt_date, end_date):
        ...
        model = lstm(len(self.factor_list), self.hidden_size, self.mum_layers,)
        if self.is_gpu:
            model.cuda()

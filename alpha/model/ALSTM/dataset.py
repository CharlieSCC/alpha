...
class TabularDataset(Dataset):
    def __init__(self,
        ...
        self.trade_dates = self.get_trade_dates(look_back_window,srt_date, end_date)
    ...
    @staticmethod
    def get_trade_dates(look_back_window, srt_date, end_date):
        ...
        return trade_dates[(trade_dates >= srt_date_) & (trade_dates <= end_date)]

    def __len__(self):
        return len(self.trade_dates) - self.look_back_window + 1
    ...
    def __getitem__(self, idx):
        ...
        return [data, label, [date.iloc[-1] for _ in range(len(stock_id))], stock_id]
        # return {
        #     "data": data,
        #     "label": label,
        #     "graph": graph,
